...
enum CharacteristicMapper {
    ...
    static func categoryName(for categoryType: String) -> String {
        ...
        case HMAccessoryCategoryTypeAirConditioner: return "air_conditioner"
        case HMAccessoryCategoryTypeAirDehumidifier: return "air_dehumidifier"
        case HMAccessoryCategoryTypeAirHeater: return "air_heater"
        case HMAccessoryCategoryTypeAirHumidifier: return "air_humidifier"
        case HMAccessoryCategoryTypeAudioReceiver: return "audio_receiver"
        case HMAccessoryCategoryTypeFaucet: return "faucet"
        case HMAccessoryCategoryTypeShowerHead: return "shower_head"
        ...
        case HMAccessoryCategoryTypeTelevisionSetTopBox: return "set_top_box"
        case HMAccessoryCategoryTypeTelevisionStreamingStick: return "streaming_stick"
        case HMAccessoryCategoryTypeWiFiRouter: return "wifi_router"
